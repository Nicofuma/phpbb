...
class kernel implements kernel_interface, TerminableInterface
{
	...
	{
		require($this->root_dir . 'includes/functions.' . $this->php_ext);
		require($this->root_dir . 'includes/functions_content.' . $this->php_ext);
		include($this->root_dir . 'includes/functions_compatibility.' . $this->php_ext);
		require($this->root_dir . 'includes/constants.' . $this->php_ext);
		require($this->root_dir . 'includes/utf/utf_tools.' . $this->php_ext);
	}
